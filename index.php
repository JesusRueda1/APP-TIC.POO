...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="Vista/assets/images/logo.png">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito+Sans:200,300,400,700,900|Roboto+Mono:300,400,500"> 
    <link rel="stylesheet" href="Vista/assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="Vista/assets/css/login_regist.css">

    <style type="text/css">
        .backgroundFondo{
        background: url('Vista/assets/images/fondo.jpg') no-repeat center top;
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="form">
                            <div id="signup">
                                ...
                                <form action="Configuracion/Ingreso/ingreso.php" method="post">
